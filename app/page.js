...
const educatorTestimonials = [
  { name: "Andrew", role: "Academic Manager", quote: "This AI Course Generator has revolutionized my course planning process!" },
  { name: "James", role: "University Professor", quote: "I've saved countless hours using this tool. It's a game-changer for educators." },
  { name: "Steve", role: "Remote Educator", quote: "The AI-generated content is impressively accurate and engaging. Highly recommended!" },
];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md transition-transform transform hover:scale-105">
              ...
              <p>Revise and modify AI-created modules, lessons, and quizzes.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md transition-transform transform hover:scale-105">
        ...
        <section>
          <h2 className="text-3xl font-bold text-center mb-8 animate__animated animate__fadeIn">What Professionals Say</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
